    ...
    extends ValueType
{
    ...
    /**
     * Gets the value stored in the specified {@link BitVector32.Section}.
     * @param section A {@link BitVector32.Section} that contains the value to get.
     * @return The value stored in the specified {@link BitVector32.Section}.
     */
    ...
    /**
     * Sets the value stored in the specified {@link BitVector32.Section}.
     * @param section A {@link BitVector32.Section} that contains the value to set.
        ...
        extends ValueType
    {
        ...
        /**
         * Determines whether the specified {@link BitVector32.Section} object is the same as the current {@link BitVector32.Section} object.
         * @param obj The {@link BitVector32.Section} object to compare with the current {@link BitVector32.Section} object.
         * @return {@code true} if the {@code obj} parameter is the same as the current {@link BitVector32.Section} object; otherwise {@code false}.
         */
        ...
        /**
         * Serves as a hash function for the current {@link BitVector32.Section}, suitable for hashing algorithms and data structures, such as a hash table.
         * @return A hash code for the current {@link BitVector32.Section}.
         */
        @Override
        ...
        /**
         * Returns a string that represents the current {@link BitVector32.Section}.
         * @return A string that represents the current {@link BitVector32.Section}.
         */
        @Override
        public String ToString() {
            return ToString(this);
        ...
        /**
         * Returns a string that represents the specified {@link BitVector32.Section}.
         * @param value The {@link BitVector32.Section} to represent.
         * @return A string that represents the specified {@link BitVector32.Section}.
         */
