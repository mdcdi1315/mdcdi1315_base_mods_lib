 ...
 * Thrown by the {@link ItemHelpers#GetMinecraftCreativeModeTabChecked(String)} and {@link ItemHelpers#GetCreativeModeTabChecked(Identifier)} methods.
 */
        ...
        extends RegistryObjectNotFoundException
{
     ...
     */
    public CreativeModeTabNotFoundException(@AllowNull Identifier location)
    {
    ...
    {
        return String.format("The specified creative mode tab was not found: %s" , GetObjectResourceKey().identifier());
    }
}
