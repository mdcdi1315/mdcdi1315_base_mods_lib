...
public record CreateCodecDirect_5<TC, T1, T2, T3, T4, T5>(
        ...
        Function5<T1, T2, T3, T4, T5, TC> create_function
)
        implements Func2<RecordCodecBuilder.Instance<TC>, App<RecordCodecBuilder.Mu<TC>, TC>>
{
    ...
    public App<RecordCodecBuilder.Mu<TC>, TC> function(RecordCodecBuilder.Instance<TC> input) {
        return input.group(cfd_1, cfd_2, cfd_3, cfd_4, cfd_5).apply(input, create_function);
    }
}
