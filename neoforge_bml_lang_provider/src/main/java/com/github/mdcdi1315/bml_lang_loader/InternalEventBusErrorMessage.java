...
public final class InternalEventBusErrorMessage implements Message, StringBuilderFormattable
{
    ...
    public InternalEventBusErrorMessage(final Event event, final int index, final EventListener[] listeners, final Throwable throwable) {
        //this.event = event;
        this.index = index;
