...
public interface IClientRegistryRegistrar
{
     ...
     * Note: This registers resource reload listeners for client resource packs. If you need for data packs, use the {@link com.github.mdcdi1315.basemodslib.registries.IRegistryRegistrar#RegisterResourceReloadListener(String, PreparableReloadListener)} method instead.
