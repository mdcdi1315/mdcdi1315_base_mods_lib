...
/**
 * Provides an {@link IIntEnumerator} implementation for concrete integer arrays. <br />
 * Note that this enumerator returns the elements in the reverse order than they are declared. <br />
 * For arrays that are of the {@link Integer} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ReversedArrayEnumerator} class instead.
 * @since 1.0.38
 */
public final class ReversedIntArrayEnumerator
    extends BaseIntEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link ReversedIntArrayEnumerator} class.
     * @param array The array to initialize the reversed integer array enumerator from.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReversedIntArrayEnumerator(int[] array)
     ...
     */
    public ReversedIntArrayEnumerator(int[] array, int index, int count)
    ...
    @NotNull
    @Override
    public Integer getCurrent() { return array[index]; }

    @Pure
    @Override
    public int getUncastedCurrent() { return array[index]; }
