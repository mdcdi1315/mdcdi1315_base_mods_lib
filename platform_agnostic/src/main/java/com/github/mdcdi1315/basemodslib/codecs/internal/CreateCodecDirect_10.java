...
public record CreateCodecDirect_10<TC, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
        ...
        Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TC> create_function
)
        implements Func2<RecordCodecBuilder.Instance<TC>, App<RecordCodecBuilder.Mu<TC>, TC>>
{
    ...
    public App<RecordCodecBuilder.Mu<TC>, TC> function(RecordCodecBuilder.Instance<TC> input) {
        return input.group(cfd_1, cfd_2, cfd_3, cfd_4, cfd_5, cfd_6, cfd_7, cfd_8, cfd_9, cfd_10).apply(input, create_function);
    }
}
