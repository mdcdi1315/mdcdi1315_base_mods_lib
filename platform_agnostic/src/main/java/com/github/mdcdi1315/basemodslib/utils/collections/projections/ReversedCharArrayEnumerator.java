 ...
 * For arrays that are of the {@link Character} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ReversedArrayEnumerator} class instead.
 * @since 1.0.38
 */
public final class ReversedCharArrayEnumerator
    extends BaseCharEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link ReversedCharArrayEnumerator} class.
     * @param array The array to initialize the reversed character array enumerator from.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReversedCharArrayEnumerator(char[] array)
     ...
     */
    public ReversedCharArrayEnumerator(char[] array, int index, int count)
