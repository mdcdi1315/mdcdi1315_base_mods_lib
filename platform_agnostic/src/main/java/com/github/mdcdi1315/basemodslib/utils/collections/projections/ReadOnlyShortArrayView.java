...
/**
 * Provides a read-only view of a {@code short} array as an {@link IShortEnumerable} instance. <br />
 ...
 */
public final class ReadOnlyShortArrayView
    implements IShortEnumerable,
        ISupportsCloning<Short>,
        ITraversableCollection<Short>,
        ISynchronized
{
    ...
    /**
     * Initializes a new instance of the {@link ReadOnlyShortArrayView} class.
     * @param array The array to project as a {@link IShortEnumerable} instance.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReadOnlyShortArrayView(short[] array)
     ...
     */
    public ReadOnlyShortArrayView(short[] array, int offset, int count)
     ...
     */
    public short GetUnboxedItem(int index)
    ...
    @NotNull
    @Override
    public ReadOnlyShortArrayView Clone() { return new ReadOnlyShortArrayView(this.array, this.start, GetCount()); }

    @Pure
    @NotNull
    @Override
    public ShortArrayEnumerator GetEnumerator() { return new ShortArrayEnumerator(this.array, start, bound - start); }

    @NotNull
    @Override
    public ReadOnlyShortArrayView Slice(int count) throws ArgumentException { return new ReadOnlyShortArrayView(array, start, count); }

    @NotNull
    @Override
    public ReadOnlyShortArrayView Slice(int index, int count) throws ArgumentException { return new ReadOnlyShortArrayView(array, start + index, count); }
}
