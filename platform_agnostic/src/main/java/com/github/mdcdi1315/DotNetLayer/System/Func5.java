...
/**
 * Encapsulates a method that has four parameters and returns a value of the type specified by the {@link TResult} parameter.
...
public interface Func5<
     ...
     */
    TResult function(T1 input_1, T2 input_2, T3 input_3, T4 input_4);
}