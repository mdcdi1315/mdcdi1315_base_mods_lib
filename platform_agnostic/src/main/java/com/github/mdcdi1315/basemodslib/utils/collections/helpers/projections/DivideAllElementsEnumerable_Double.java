...
public record DivideAllElementsEnumerable_Double(IDoubleEnumerable enumerable, double value)
    implements IDoubleEnumerable
{
    private record Enumerator(IDoubleEnumerator enumerator, double div_value)
