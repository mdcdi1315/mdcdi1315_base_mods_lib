    ...
    extends OutOfMemoryException
{
     ...
     */
    public InsufficientMemoryException(@MaybeNull String message) {
        super(message);
    }
     ...
     */
    public InsufficientMemoryException(@MaybeNull String message, @MaybeNull Exception innerException) {
