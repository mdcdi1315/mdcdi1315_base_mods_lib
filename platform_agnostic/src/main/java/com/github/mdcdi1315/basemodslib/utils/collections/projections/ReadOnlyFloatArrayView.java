 ...
 */
public final class ReadOnlyFloatArrayView
    implements IFloatEnumerable,
        ISupportsCloning<Float>,
        ITraversableCollection<Float>,
        ISynchronized
{
    ...
    /**
     * Initializes a new instance of the {@link ReadOnlyFloatArrayView} class.
     * @param array The array to project as a {@link IFloatEnumerable} instance.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReadOnlyFloatArrayView(float[] array)
     ...
     */
    public ReadOnlyFloatArrayView(float[] array, int offset, int count)
     ...
     */
    public float GetUnboxedItem(int index)
    ...
    @NotNull
    @Override
    public ReadOnlyFloatArrayView Clone() { return new ReadOnlyFloatArrayView(this.array, this.start, GetCount()); }
    ...
    @NotNull
    @Override
    public ReadOnlyFloatArrayView Slice(int count) throws ArgumentException { return new ReadOnlyFloatArrayView(array, start, count); }
