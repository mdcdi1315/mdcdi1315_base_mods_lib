    ...
    implements IAlchemyRegistrar
{
    ...
    {
        NeoForgeUtils.DeferredRegister_RegisterIfHasItems(event_bus, POTION_REGISTER);
        NeoForgeUtils.DeferredRegister_RegisterIfHasItems(event_bus, PARTICLE_TYPE_REGISTER);
