...
// Manages and handles the workflow of item stacks in Forge.
    ...
    implements Action1<BuildCreativeModeTabContentsEvent>
{
    ...
    private record DeferredItemRegisterSupplier(RegistryObject<? extends ItemLike> item)
    ...
    public void RegisterDeferredItem(CreativeModeTab[] tabs, RegistryObject<? extends ItemLike> item)
    {
    ...
    public void RegisterToEventBus(IEventBus bus)
    {
        ...
        {
            ForgeUtils.AddListener(bus, BuildCreativeModeTabContentsEvent.class, this);
        }
