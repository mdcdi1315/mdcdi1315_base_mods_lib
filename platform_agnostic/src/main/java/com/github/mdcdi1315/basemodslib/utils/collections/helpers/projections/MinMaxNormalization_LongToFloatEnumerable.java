...
public record MinMaxNormalization_LongToFloatEnumerable(ILongEnumerable enumerable, long min, long max)
        implements IFloatEnumerable
{
    private record Enumerator(ILongEnumerator enumerator, float min, float max)
