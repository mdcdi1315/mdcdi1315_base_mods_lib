...
public record CreateCodecDirect_7<TC, T1, T2, T3, T4, T5, T6, T7>(
        ...
        Function7<T1, T2, T3, T4, T5, T6, T7, TC> create_function
)
        implements Func2<RecordCodecBuilder.Instance<TC>, App<RecordCodecBuilder.Mu<TC>, TC>>
{
    ...
    public App<RecordCodecBuilder.Mu<TC>, TC> function(RecordCodecBuilder.Instance<TC> input) {
        return input.group(cfd_1, cfd_2, cfd_3, cfd_4, cfd_5, cfd_6, cfd_7).apply(input, create_function);
    }
}
