...
/**
 * Provides a read-only view of a {@code int} array as an {@link IDoubleEnumerable} instance. <br />
        ...
        ISynchronized
{
    ...
    @NotNull
    @Override
    public DoubleArrayEnumerator GetEnumerator() { return new DoubleArrayEnumerator(this.array, start, bound - start); }
