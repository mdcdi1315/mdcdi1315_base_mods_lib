 ...
 * For arrays that are of the {@link Integer} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ArrayEnumerator} class instead.
 */
@Pure
    ...
    extends BaseIntEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link IntArrayEnumerator} class.
     * @param array The array to initialize the integer array enumerator from.
     ...
     */
    public IntArrayEnumerator(int[] array, int index, int count)
