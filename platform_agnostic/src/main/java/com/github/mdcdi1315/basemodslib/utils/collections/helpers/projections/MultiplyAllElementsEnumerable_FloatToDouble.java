...
public record MultiplyAllElementsEnumerable_FloatToDouble(IFloatEnumerable enumerable, double value)
    implements IDoubleEnumerable
{
    private record Enumerator(IFloatEnumerator enumerator, double value)
