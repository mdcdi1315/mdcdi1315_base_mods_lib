...
/**
 * Encapsulates a method that has 16 parameters and returns a value of the type specified by the {@link TResult} parameter.
 ...
 * @param <T14> The type of the fourteenth parameter of the method that this delegate encapsulates.
 * @param <T15> The type of the fifteenth parameter of the method that this delegate encapsulates.
 * @param <T16> The type of the sixteenth parameter of the method that this delegate encapsulates.
...
public interface Func17<
        ...
        @DotNetByRefParameter(ByRefParameterType.IN) T14,
        @DotNetByRefParameter(ByRefParameterType.IN) T15,
        @DotNetByRefParameter(ByRefParameterType.IN) T16,
        ...
        >
{
     ...
     * @param input_14 The fourteenth parameter of the method that this delegate encapsulates.
     * @param input_15 The fifteenth parameter of the method that this delegate encapsulates.
     * @param input_16 The sixteenth parameter of the method that this delegate encapsulates.
     * @return The return value of the method that this delegate encapsulates.
     */
    TResult function(T1 input_1, T2 input_2, T3 input_3, T4 input_4, T5 input_5, T6 input_6, T7 input_7, T8 input_8, T9 input_9, T10 input_10, T11 input_11, T12 input_12, T13 input_13, T14 input_14, T15 input_15, T16 input_16);
}
