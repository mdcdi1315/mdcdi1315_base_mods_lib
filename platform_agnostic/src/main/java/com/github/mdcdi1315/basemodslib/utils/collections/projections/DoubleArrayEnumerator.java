...
/**
 * Provides an {@link IFloatEnumerator} implementation for concrete double-precision floating-point integer arrays. <br />
 * For arrays that are of the {@link Double} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ArrayEnumerator} class instead.
 */
public final class DoubleArrayEnumerator
    extends BaseDoubleEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link DoubleArrayEnumerator} class.
     * @param array The array to initialize the double-precision floating-point integer array enumerator from.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public DoubleArrayEnumerator(double[] array)
     ...
     */
    public DoubleArrayEnumerator(double[] array, int index, int count)
    ...
    @NotNull
    @Override
    public Double getCurrent() { return array[index]; }

    @Pure
    @Override
    public double getUncastedCurrent() { return array[index]; }

    @Pure
    @Override
    public void ResetImpl() { index = start; }

    @Pure
    @Override
    public boolean MoveNextImpl() { return ++index < bound; }
