 ...
 */
public final class ReadOnlyByteArrayView
    implements IByteEnumerable,
        ISupportsCloning<Byte>,
        ITraversableCollection<Byte>,
        ISynchronized
{
    ...
    /**
     * Initializes a new instance of the {@link ReadOnlyByteArrayView} class.
     * @param array The array to project as a {@link IByteEnumerable} instance.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReadOnlyByteArrayView(byte[] array)
     ...
     */
    public ReadOnlyByteArrayView(byte[] array, int offset, int count)
     ...
     */
    public byte GetUnboxedItem(int index)
    ...
    @NotNull
    @Override
    public ReadOnlyByteArrayView Clone() { return new ReadOnlyByteArrayView(this.array, this.start, GetCount()); }
    ...
    @NotNull
    @Override
    public ReadOnlyByteArrayView Slice(int count) throws ArgumentException { return new ReadOnlyByteArrayView(array, start, count); }
