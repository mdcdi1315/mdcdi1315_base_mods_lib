    ...
    implements IClientRegistryRegistrar
{
    ...
    private SingleLinkedListBasedRegister<Pair<Identifier, PreparableReloadListener>> client_resource_reload_listeners;
    ...
    private static void RegisterClientReloadListener(AddClientReloadListenersEvent event, Pair<Identifier, PreparableReloadListener> entry) { event.addListener(entry.first(), entry.second()); }
