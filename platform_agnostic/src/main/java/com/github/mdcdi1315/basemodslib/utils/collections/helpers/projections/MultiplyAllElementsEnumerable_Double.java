...
public record MultiplyAllElementsEnumerable_Double(IDoubleEnumerable enumerable, double value)
    implements IDoubleEnumerable
{
    private record Enumerator(IDoubleEnumerator enumerator, double value)
