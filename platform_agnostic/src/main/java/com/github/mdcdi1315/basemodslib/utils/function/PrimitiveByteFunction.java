...
public interface PrimitiveByteFunction<TR>
    extends PrimitiveNumericFunction<Byte, TR>
{
    ...
    @Override
    default TR convert(Byte value) { return function(value.byteValue()); }

    @Override
    default TR function(Byte value) { return function(value.byteValue()); }
}
