 ...
 * For arrays that are of the {@link Byte} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ReversedArrayEnumerator} class instead.
 * @since 1.0.38
 */
public final class ReversedByteArrayEnumerator
    extends BaseByteEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link ReversedByteArrayEnumerator} class.
     * @param array The array to initialize the reversed byte array enumerator from.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReversedByteArrayEnumerator(byte[] array)
     ...
     */
    public ReversedByteArrayEnumerator(byte[] array, int index, int count)
