 ...
 * using {@linkplain ByteOrder#BIG_ENDIAN big endian order} (aka. "network order"). <br />
 ...
 * Note: This class has been ported from {@code jdk.internal.util.ByteArray}, update this as appropriate.
 */
public final class ByteArray
{
    ...
    private static VarHandle create(Class<?> viewArrayClass) { return MethodHandles.byteArrayViewVarHandle(viewArrayClass, ByteOrder.BIG_ENDIAN); }
