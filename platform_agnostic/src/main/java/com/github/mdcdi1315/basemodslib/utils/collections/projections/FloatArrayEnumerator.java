...
/**
 * Provides an {@link IFloatEnumerator} implementation for concrete single-precision floating-point integer arrays. <br />
 * For arrays that are of the {@link Float} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ArrayEnumerator} class instead.
 */
public final class FloatArrayEnumerator
    extends BaseFloatEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link FloatArrayEnumerator} class.
     * @param array The array to initialize the single-precision floating-point integer array enumerator from.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public FloatArrayEnumerator(float[] array)
     ...
     */
    public FloatArrayEnumerator(float[] array, int index, int count)
