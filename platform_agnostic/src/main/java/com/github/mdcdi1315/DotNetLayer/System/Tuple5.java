    ...
    implements ITuple
{
    ...
    /**
     * Gets the value of the current {@link Tuple5} object's first component.
     * @return The value of the current {@link Tuple5} object's first component.
     */
    public T1 GetItem1() { return m_Item1; }

    /**
     * Gets the value of the current {@link Tuple5} object's second component.
     * @return The value of the current {@link Tuple5} object's second component.
     */
    public T2 GetItem2() { return m_Item2; }

    /**
     * Gets the value of the current {@link Tuple5} object's third component.
     * @return The value of the current {@link Tuple5} object's third component.
     */
    public T3 GetItem3() { return m_Item3; }

    /**
     * Gets the value of the current {@link Tuple5} object's fourth component.
     * @return The value of the current {@link Tuple5} object's fourth component.
     */
    public T4 GetItem4() { return m_Item4; }

    /**
     * Gets the value of the current {@link Tuple5} object's fifth component.
     * @return The value of the current {@link Tuple5} object's fifth component.
     */
    public T5 GetItem5() { return m_Item5; }

    /**
     * Initializes a new instance of the {@link Tuple5} class.
    ...
    @Override
    public String toString() { return StringUtils.Concat("(", m_Item1, ", ", m_Item2, ", ", m_Item3, ", ", m_Item4, ", ", m_Item5, ")"); }
}
