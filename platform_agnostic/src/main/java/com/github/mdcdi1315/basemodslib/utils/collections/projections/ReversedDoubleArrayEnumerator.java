...
/**
 * Provides an {@link IFloatEnumerator} implementation for concrete double-precision floating-point arrays. <br />
 * Note that this enumerator returns the elements in the reverse order than they are declared. <br />
 * For arrays that are of the {@link Double} boxed type, use the {@link com.github.mdcdi1315.basemodslib.utils.collections.ReversedArrayEnumerator} class instead.
 * @since 1.0.38
 */
public final class ReversedDoubleArrayEnumerator
    extends BaseDoubleEnumerator
{
    ...
    /**
     * Initializes a new instance of the {@link ReversedDoubleArrayEnumerator} class.
     * @param array The array to initialize the reversed double-precision floating-point array enumerator from.
     * @throws ArgumentNullException {@code array} is {@code null}.
     */
    public ReversedDoubleArrayEnumerator(double[] array)
     ...
     */
    public ReversedDoubleArrayEnumerator(double[] array, int index, int count)
